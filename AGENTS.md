...
| generic-review | Code Review | Full-diff review without a PR URL: shared requirements, KFP/Go/Python routing, severity and output template, then review-the-review self-validation; used by TDD Phase H and after pr-review | Active | `skills/generic-review/` |
