...
4. Execute **Phase 2** of `pr-review-checklist.md` (suppress findings already raised on the PR). If any numbered finding was removed or merged, re-read `../../prompts/review-shared/review-the-review.md` and fix the output in place before presenting.
