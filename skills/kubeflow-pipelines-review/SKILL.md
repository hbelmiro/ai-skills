...
2. Start with Go baseline checks by reading `../review-shared/go-review-checklist.md`.
3. Apply Python baseline checks by reading `../review-shared/python-review-checklist.md`.
